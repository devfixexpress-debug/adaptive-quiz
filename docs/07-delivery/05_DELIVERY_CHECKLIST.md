...
- [x] PostgreSQL levanta desde cero (evidencia certificada de PostgreSQL 17.11).
- [x] Flyway ejecuta V1 (V1, V1.1 y V2 validadas en runtime).
- [x] Seed cargado (evidencia certificada).
- [x] Demo usa datos reales (evidencia E2E certificada).
